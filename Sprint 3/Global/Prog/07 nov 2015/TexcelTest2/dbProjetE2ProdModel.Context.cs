...
namespace Projet
{
    ...
    public partial class dbProjetE2ProdEntities : DbContext
    {
        ...
        [DbFunction("dbProjetE2ProdEntities", "GetEmployeByRole")]
        public virtual IQueryable<GetEmployeByRole_Result> GetEmployeByRole(Nullable<int> role)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetEmployeByRole_Result>("[dbProjetE2ProdEntities].[GetEmployeByRole](@role)", roleParameter);
        }
    }
}
