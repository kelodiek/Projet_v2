...
namespace Projet
{
    public partial class frmGesGroupeUser : frmGestion
    {
        ...
        private void chargerColonne()
        {
            ...
            gridGroupUser.SortCompare += gridGroupUser_SortCompare;
        ...
        private void gridGroupUser_SortCompare(object sender, DataGridViewSortCompareEventArgs e)
        {
            if (e.Column == gridGroupUser.Columns[0])
            {
