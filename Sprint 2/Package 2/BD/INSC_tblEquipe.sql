...
INSERT INTO Personnel.tblEquipe(IdEquipe,NomEquipe,CommentEquipe,IdChefEquipe,Statut) values(105,'PerformanceElevé','Testeur expert en test de performance',6,'A');
INSERT INTO Personnel.tblEquipe(IdEquipe,NomEquipe,CommentEquipe,IdChefEquipe,Statut) values(106,'LesBonParleurs','Expert des langues',18,'A');
INSERT INTO Personnel.tblEquipe(IdEquipe,NomEquipe,CommentEquipe,IdChefEquipe,Statut) values(107,'MultiTache',NULL,20,'A');
INSERT INTO Personnel.tblEquipe(IdEquipe,NomEquipe,CommentEquipe,IdChefEquipe,Statut) values(108,'Les Admin','Regroupe les admins',2,'A');
